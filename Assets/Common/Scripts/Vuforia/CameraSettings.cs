...
public class CameraSettings : MonoBehaviour
{
    ...
    public IEnumerator PhotoWithFlashlight()
    {
        VuforiaBehaviour.Instance.CameraDevice.SetFlash(true);
        mIsFlashTorchEnabled = true;
    ...
    IEnumerator captureScreenshot()
    {
        ...
        string path = Application.persistentDataPath + Screen.width + "X" + Screen.height + "" + ".png";
    ...
    public void TakePhotoWithFlashlight()
    {
